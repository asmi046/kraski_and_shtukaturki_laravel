<li class="menu-list__item"><a href="{{route('about')}}" class="menu-list__link">О нас</a></li>
<li class="menu-list__item"><a href="{{route('catalog')}}" class="menu-list__link">Магазин</a></li>
